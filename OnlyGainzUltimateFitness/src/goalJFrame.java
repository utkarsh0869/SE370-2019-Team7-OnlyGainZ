...
public class goalJFrame extends javax.swing.JFrame {
    ...
    public void saveGoalToFile() {
        try {
            ...
            filewriter.write(goals.get(gi).getGoalAuthor()+"  ");
            filewriter.write(goals.get(gi).getGoalDesc()+"  ");
            filewriter.write(goals.get(gi).getGoalEndDate()+"  ");
            filewriter.write(goals.get(gi).getGoalDifficulty()+"  ");
            filewriter.write(goals.get(gi).getGoalType()+"\n");
            gi++;
